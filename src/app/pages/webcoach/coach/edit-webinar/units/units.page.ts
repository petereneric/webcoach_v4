...
export class UnitsPage implements OnInit {
  ...
  addUnit(section: Section) {
    let newUnit = {id: 0, cName: "", kSection: section.id, secDuration: 0, oUnitPlayer: null, imgThumbnail: "", bMaterial: false, lMaterials: [], bVideo: false, nPosition: section.lUnits.length+1}
