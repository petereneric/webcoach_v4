...
export class UnitsPage implements OnInit {
  ...
  addUnit(section: Section) {
    let newUnit = {id: 0, cName: "", lIntervals: [], lComments: [], kSection: section.id, secDuration: 0, oUnitPlayer: null, imgThumbnail: "", bMaterial: false, lMaterials: [], bVideo: false, nPosition: section.lUnits.length+1, bSample: 0}
